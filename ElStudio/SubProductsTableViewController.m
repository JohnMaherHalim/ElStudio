//
//  SubProductsTableViewController.m
//  ElStudio
//
...
@interface SubProductsTableViewController ()

@end

@implementation SubProductsTableViewController
...
- (void)viewDidLoad {
    ...
    //self.products = [[ProductsStore sharedManager]Products] ;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    globalprod = product ;
    [self performSegueWithIdentifier: @"SubToDetails" sender: self];
}

- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"SubToDetails"]) {
